...
```
for %s in (gateway webhook orchestrator reviewer learner) do echo 6918 > services\%s\deploy.txt
```
...
```
for %s in (gateway webhook orchestrator reviewer learner) do echo 4566 > services\%s\deploy.txt
```
